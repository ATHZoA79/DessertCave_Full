...
<body>
    ...
    <main>
        ...
        <div id="container">
            ...
            <form id="content" action="{{ route('store_news') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="content-left">
                    ...
                    <li>內文</li>
                    <textarea cols="30" rows="10" name="news_content"></textarea>
                </div>
